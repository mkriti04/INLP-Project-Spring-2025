...
def load_embeddings(embedding_type):
    ...
    try:
        ...
        if embedding_type == 'tfidf':
            file_name = "../datsets/interim/embeddings/pt/tfidf_features_1.pt"
        elif embedding_type == 'sbert':
            file_name = f"../datsets/interim/embeddings/pt/{embedding_type}_output_1.pt"
        else:
            file_name = f"../datsets/interim/embeddings/pt/{embedding_type}_1.pt"        
        ...
        if embedding_type == 'tfidf':
            file_name = "../datasets/interim/embeddings/csv/tfidf_2.csv"
        elif embedding_type == "sbert":
            return
        else:
            return
